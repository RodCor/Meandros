"""
Mask R-CNN
The main Mask R-CNN model implementation with some modifications.
"""
...
import roi_detection_module.utils as utils
from roi_detection_module.parallel_model import ParallelModel
...
class MaskRCNN(object):
    ...
    def compile(self, learning_rate, momentum):
        ...
        """
        # Optimizer object - using legacy optimizer for compatibility
        optimizer = keras.optimizers.legacy.SGD(
            learning_rate=learning_rate,  # Using learning_rate instead of lr
            momentum=momentum,
