...
class Zoom_Advanced(ttk.Frame):
    ...
    def __init__(self, mainframe, im):
        ...
        self.canvas = tk.Canvas(self.master, highlightthickness=10,
        ...
        self.image = im  # Image.open(im)  # open image
